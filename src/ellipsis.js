    ...
    return (
      <div>
        ...
        <div className="links">
          ...
          <div style={{ border: '0px solid silver', overflow: 'hidden', margin: '15px auto', width: '1450px', }}><iframe title="Ellipsis (Deluxe) by Telephone Sound, embedded from Choon." style={{ border: '0px none', marginLeft: '-260px', height: '1200px', marginTop: '-50px', width: '100%' }} src="https://choon.co/albums/0anfx644aqq/ellipsis-deluxe" scrolling="no"><span style={{ display: 'inline-block', width: '0px', overflow: 'hidden', lineHeight: 0 }} data-mce-type="bookmark" class="mce_SELRES_start">?</span></iframe></div>
